...
%==============================================================================
\title{Estudo e aplicação da técnica de Steering Behaviors na simulação física de fluidos em um espaço tridimensional}

\author{Vicentini}{Henrique}
...
\trabalhoNumero{Dissertação de Mestrado Nº X}

% orientador e co-orientador são opcionais (não diga isso pra eles :))
\advisor[Prof.~Dr.]{Pozzer (UFSM)}{Cesar Tadeu}
\coadvisor[Prof.~Dr.]{d'Ornellas (UFSM)}{Marcos Cordeiro}

\committee[Prof.~Dr.]{Charão (UFSM)}{Andrea Schwertner}
\committee[Prof.~Dr.]{Stein (UFSM)}{Benhur de Oliveira}
...
%
\keyword{Simulação de fluidos}
\keyword{steering behaviors}
...
--- \textsc{Antoine de Saint-Exupéry, Wind, sand and stars, 1939}
\end{flushright}
