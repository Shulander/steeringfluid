...
Para simulação de grupo de elementos em um sistema de steering behaviors a gravidade no mundo geralmente não é relevante para o resultado esperado, porém em uma representação gráfica de fluídos a gravidade é importante para o correto fluxo dos elementos e da representação correta dos elementos.
