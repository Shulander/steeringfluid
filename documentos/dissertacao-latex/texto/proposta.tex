...
Em visualizações de simulação foram constatados semelhanças na dinâmica da movimentação de comportamento em grupo ({\it flocking}) com a simulação de fluidos, algum desses elementos podem ser visualizados na Figura \ref{fig:steering_big-shoal} aonde pode se verificar linhas de fluxo dos elementos através dos obstáculos, os quais se comportaram como escoamento de um fluido através dos elementos do cenário. Essa visualização foi verificado em um ambiente bidimensional, porém o conceito será ampliado e testado em um ambiente tridimensional.
\begin{figure}
\centering
